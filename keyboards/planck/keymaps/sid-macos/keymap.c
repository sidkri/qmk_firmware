...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_planck_grid(
      ...
      */
      LT(5,KC_TAB),             KC_Q,                   KC_W,                   KC_E,                   KC_R,                   KC_T,
                                KC_Y,                   KC_U,                   KC_I,                   KC_O,                   KC_P,                   LALT(KC_BSPACE),
      LCTL_T(KC_GRAVE),         LT(1,KC_A),             LT(6,KC_S),             KC_D,                   KC_F,                   KC_G,
                                KC_H,                   KC_J,                   KC_K,                   KC_L,                   KC_SCOLON,              KC_QUOTE,
      KC_LSHIFT,                LT(4,KC_Z),             KC_X,                   KC_C,                   KC_V,                   KC_B,
                                KC_N,                   KC_M,                   KC_COMMA,               KC_DOT,                 KC_SLASH,               KC_ENTER,
      MT(MOD_HYPR, KC_ESCAPE),  MO(4),                  KC_AT,                  KC_LALT,                LGUI_T(KC_BSPACE),      KC_BSPACE,
  ...
  [_RAISE] = LAYOUT_planck_grid(
      ...
      KC_TRANSPARENT,           KC_TRANSPARENT,         KC_MINUS,               KC_LPRN,                KC_RPRN,                KC_PIPE,
  ...
  [_LAYER6] = LAYOUT_planck_grid(
      KC_TRANSPARENT,           DYN_REC_STOP,           DYN_REC_START1,         DYN_MACRO_PLAY1,        DYN_MACRO_PLAY2,        LALT(KC_F4),
                                KC_TRANSPARENT,         LCTL(KC_LEFT),          KC_UP,                  LCTL(KC_RIGHT),         KC_TRANSPARENT,         LCTL(KC_BSPACE),
      KC_TRANSPARENT,           LCTL(KC_MINUS),         KC_TRANSPARENT,         LALT(KC_F12),           KC_F12,                 LALT(KC_TAB),
                                KC_HOME,                KC_LEFT,                KC_DOWN,                KC_RIGHT,               KC_END,                 KC_TRANSPARENT,
      KC_TRANSPARENT,           LCTL(KC_F4),            DYN_REC_START2,         LSFT(KC_F12),           KC_F5,           ST_MACRO_0,
                                LSFT(KC_HOME),          LCTL(LSFT(KC_LEFT)),    KC_END,                 LCTL(LSFT(KC_RIGHT)),   LSFT(KC_END),           KC_TRANSPARENT,
      KC_TRANSPARENT,           KC_TRANSPARENT,         KC_TRANSPARENT,         KC_TRANSPARENT,         KC_TRANSPARENT,         KC_TRANSPARENT,
                                KC_TRANSPARENT,         KC_TRANSPARENT,         KC_TRANSPARENT,         KC_TRANSPARENT,         KC_RCTRL,               KC_RSHIFT),
};
